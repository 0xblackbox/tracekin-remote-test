...
3. After that one-time opt-in, new Codex sessions share by default. The dashboard shows pending, acknowledged, and paused-session counts plus the locally retained delivery receipts.
